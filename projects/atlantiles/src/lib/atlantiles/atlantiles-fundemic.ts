...
@Injectable()
export class AtlantilesFundemic extends Game  {
    ...
    private  h_loops(args: unknown[]): void { // type: string, currentTarget: Loop): void {
    ...
    public destroy(): IContainer {
        ...
        if (this.victory)   { this.victory.removeEventListener(LEvent.GO_SCREEN, this.h_loops.bind(this)); }
        if (this.gameplay)  { this.gameplay.removeEventListener(LEvent.GO_SCREEN, this.h_loops.bind(this)); }
        if (this.startmenu) { this.startmenu.removeEventListener(LEvent.GO_SCREEN, this.h_loops.bind(this)); }
        if (this.instructions) { this.instructions.removeEventListener(LEvent.GO_SCREEN, this.h_loops.bind(this)); }
        if (this.settings) { this.settings.removeEventListener(LEvent.GO_SCREEN, this.h_loops.bind(this)); }

        if (this.levelID) { this.levelID.destroy(); }
