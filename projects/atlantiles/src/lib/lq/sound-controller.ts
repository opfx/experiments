...
export class SoundController {
    ...
    constructor()
    {
        ...
        {
            console.error('[SoundController] is a singleton!');
        }
     ...
     */
    public playSound(id: string, loop0: boolean = false, onComplete: () => void = null): void {
        ...
        /* if (sound.exists(id)) {
            ...
            if (loop0 || onComplete)
            {
                sound.play(id, {loop: loop0, complete: onComplete} );
            }else
            {
                sound.play(id);
            }
